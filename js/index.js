...
$(".i1").click(
  function() {
    $(".discription_img").css("background-image", "url(./img/i1.jpg)");
...
$(".i2").click(
  function() {
    $(".discription_img").css("background-image", "url(./img/i2.jpg)");
...
$(".i3").click(
  function() {
    $(".discription_img").css("background-image", "url(./img/i3.jpg)");
...
$(".i4").click(
  function() {
    $(".discription_img").css("background-image", "url(./img/i4.jpg)");
...
$(".i5").click(
  function() {
    $(".discription_img").css("background-image", "url(./img/i5.jpg)");
...
$(".i6").click(
  function() {
    $(".discription_img").css("background-image", "url(./img/i6.jpg)");
...
$(".i7").click(
  function() {
    ...
    $(".discription_img").css("background-image", "url(./img/i7.jpg)");
